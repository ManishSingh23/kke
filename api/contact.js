...
module.exports = async function handler(req, res) {
  ...
  res.setHeader(
    ...
    "GET,OPTIONS,// api/contact.js - Final Working Version
const nodemailer = require('nodemailer');
...
module.exports = async function handler(req, res) {
  ...
  try {
    const { name, email, phone, company, products, message, website } = req.body;
    ...
    // Create transporter - Fixed for Vercel
    ...
    res.status(500).json({
      success: false,
      message: 'Unable to send email at the moment. Please contact us directly at admin@krishnakavach.com or call +91 8860838343.'
    });
  }
};ATCH,DELETE,POST,PUT"
  );
  res.setHeader(
    "Access-Control-Allow-Headers",
    "X-CSRF-Token, X-Requested-With, Accept, Accept-Version, Content-Length, Content-MD5, Content-Type, Date, X-Api-Version"
